...
return array(
	...
	'index_page' => array(
		 ...
		 * at `app/views/packages/fbf/laravelblog/posts/index.blade.php`.
		 *
		 * @type string
		 */
		'view' => 'laravelblog::posts.index',
	...
	'view_page' => array(
		 ...
		 * view file inside you own app at `app/views/packages/fbf/laravelblog/posts/view.blade.php`.
		 */
		'view' => 'laravelblog::posts.view',
		 ...
		 * partial, just override it by creating a new file at `app/views/packages/fbf/laravelblog/partials/share.blade.php`
		 *
		 * @type bool
		 */
