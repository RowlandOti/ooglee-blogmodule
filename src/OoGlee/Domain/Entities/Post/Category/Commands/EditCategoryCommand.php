...
/**
 * Class EditCategoryCommand -- Defines that our application can 
 * edit a post. This functions like a Data Transfer Object (DTO)
 *
 ...
 */
class EditCategoryCommand extends ACommand implements ICommand {
{
