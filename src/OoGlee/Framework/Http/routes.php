...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin'], function()
{
    Route::group(['middleware' => 'auth'], function() 
    {
		...
		Route::get(OogleeBConfig::get('config.post_routes.base_uri_admin').'/post/{id}/edit', ['as' => 'admin.post.edit', 'uses' => 'PostsController@getEdit']);
		Route::post(OogleeBConfig::get('config.post_routes.base_uri_admin').'/post/{id}/edit', ['as' => 'admin.post.edit', 'uses' => 'PostsController@postEdit']);
        // Delete resource
		Route::get(OogleeBConfig::get('config.post_routes.base_uri_admin').'/post/{id}/delete', ['as' => 'admin.post.delete', 'uses' => 'PostsController@postDelete']);
    });
});
